...
def create_task(
    ...
    # A recipe resolution froze its project context up front; never reopen board defaults per node.
    if _resolved_recipe_context is None and project_id is None and workspace_kind != "scratch":
        try:
